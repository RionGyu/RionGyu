...
### 세움웹
##### 기프트테크 구축
- 기간 : 2025.12.01~2025.05.30
- 개요 : 그누보드 상품권 쇼핑몰
- 사용기술 : PHP, javascript,jquery, mySQL
- 담당업무 : 상품권 발권 및 관리 시스템 개발
-            휴대폰 결제, 신용카드 결제 API 연동 및 결제 처리 로직 구현
-            1:1 문의 게시판 기능 개발 및 관리자 대응 시스템 설계
##### 블루존 고도몰 튜닝
- 기간 : 2024.12.01~2025.03.31
- 개요 : 고도몰 커스터마이징 및 유지보수
- 사용기술 : PHP, javascript,jquery, mySQL
- 담당업무 : 고도몰 backend 개선(자연어 검색처리, 각종 상품 성분 관리 설계 및 조회) 
##### 클린24 고도몰 튜닝
